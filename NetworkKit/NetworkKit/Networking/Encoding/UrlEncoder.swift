...
public class UrlEncoder {
     ...
     */
    private static func queryComponents(_ key: String, _ value: Any, isFormData: Bool = false) -> [(String, String)] {
        var components: [(String, String)] = []
     ...
     */
    private static func escape(string: String, plusForSpace: Bool = false) -> String {
